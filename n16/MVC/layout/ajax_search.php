...
if (isset($_GET['keyword'])) {
    ...
    if (!empty($results)) {
       ...
       ';}
        echo '  <a href="index.php?trang=product" class="see-all-search" title="Xem tất cả">Xem tất cả kết quả »</a>';
    } else {
        echo '<div class="not-pro">Không có thấy kết quả tìm kiếm</div>';
    }
}
?>
