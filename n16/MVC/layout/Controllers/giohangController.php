                ...
                $ch .= '<div class="ajaxcart__inner ajaxcart__inner--has-fixed-footer cart_body items">
                                         <div class="ajaxcart__row">
                                             <div class="ajaxcart__product cart_product" data-line="1">
                                                           <a href="/set-qua-2010-maneli-1-boi-bo-suc-khoe-duong-nhan"
                                                            ...
                                                            <div class="grid__item cart_info single-cart-product">
    ...
    <a title="Xóa" class="cart__btn-remove remove-item-cart ajaxifyCart--remove" href="Model/giohangmodel.php?ma=xoa&id=' . $b['id'] . '" data-line="1">Xóa</a>
                                                                ...
                                                                <div class="grid">
                                                                    <div class="grid__item one-half text-right cart_prices">
                                                                        <span class="single-cart-price" data-price>' . $b['gia'] . '₫</span>
                                                                    </div>
                                                                </div>
                                                                <div class="grid">
                                                                    <div class="grid__item one-half cart_select">
                                                                        <div class="" style="display: flex;justify-content:space-between;gap:10px;   ">
                                                                            ...
                                                                            <div class="ajaxcart__qty-num number-sidebar">' . $b['sl'] . '</div>
                                                                ...
                                                                <div class="grid justify-right">
                                                                    <div class="grid__item one-half text-right cart_prices">
                                                                        <span class="total-cart-price">' . $b['gia'] . '₫</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                       </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        singleCartProduct.forEach(pd => {
            ...
            let inputValue = parseInt(qtyNum.textContent); // Lấy số lượng ban đầu
            ...
            plus.onclick = () => {
                ...
                const totalPrice = inputValue * price; // Tính tổng tiền sử dụng giá ban đầu
                totalPriceElem.textContent = totalPrice.toLocaleString() + "₫"; // Cập nhật tổng tiền
                getTotal(); // Cập nhật tổng giá giỏ hàng
            };
