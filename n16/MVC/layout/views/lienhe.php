<link href="public/css/lienhe.css" rel="stylesheet" type="text/css" media="all" />
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-12">
                                <div class="contact">
                                    ...
                                    <div class="time_work">
                                        ...
                                        <div class="item">
                                            <b>Hotline:</b> <a class="fone" href="tel:19006750" title="1900 6750">1900
                                                6750</a>
                                        </div>
                                        <div class="item">
                                        ...
                                        <div class="item">
                                            <a href="index.html" class="btn btn-primary frame"
                                ...
                                <div class="form-contact">
                                    ...
                                    <div id="pagelogin">
                                        <form method="post" action="/postcontact" id="contact" accept-charset="UTF-8">
                                            <input name="FormType" type="hidden" value="contact"><input name="utf8"
                                                type="hidden" value="true"><input type="hidden"
                                                id="Token-08c2d21248a947cb94a0f2bf6a1e82ff" name="Token" value="">
                                            <div class="group_contact">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                                        <input placeholder="Họ và tên" type="text"
                                                            class="form-control  form-control-lg" required=""
                                                            value="Tâm Nguyễn Bá" name="contact[Name]">
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                                        <input placeholder="Email" type="email"
                                                            pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"
                                                            required="" id="email1" class="form-control form-control-lg"
                                                            value="tamnguyenthia0@gmail.com" name="contact[email]">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <textarea placeholder="Nội dung" name="contact[body]"
                                                            ...
                                                            required=""></textarea>
                                                        <button type="submit" class="btn btn-primary">Gửi tin nhắn <svg
                            ...
                            <div class="col-lg-7 col-12">
                                <div id="contact_map" class="map">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8429.782517954374!2d106.61962160601269!3d10.857067325898733!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752bee0b0ef9e5%3A0x5b4da59e47aa97a8!2zQ8O0bmcgVmnDqm4gUGjhuqduIE3hu4FtIFF1YW5nIFRydW5n!5e0!3m2!1svi!2sus!4v1731866420191!5m2!1svi!2sus"
