 ...
 <?php
 $sl = isset($_POST['number']) ? (int)$_POST['number'] : 1;
...
<div class="container">
    <div class="details-product">
                       ...
                       <span class="sale" style="width: 100% display: block;">
                        ...
                        <div class="price-box clearfix">
                            <span class="special-price">
                                <span class="price product-price">'.$formattedNumber.'</span>
                                ...
                                <div class="flex-quantity">
                                    <div class="custom custom-btn-number show">
                                        ...
                                        <div class="input_number_product">
                                            <button class="btn_num num_1 button button_qty" type="submit" name="dam">-</button>
                                            <input type="number" id="qtym" name="number"
                                                maxlength="3" class="form-control prd_quantity"
                                                value='.$sl.'>
                                            <button class="btn_num num_2 button button_qty" type="submit" name="tang">+</button>
        ...
        foreach ($homemodel->binhluan as $kk) {                                            
            $ch .='    <!-- Review 2 -->
                                                <div class="user-review">
                                                    <div class="d-flex align-items-center mb-4">
                                                        ...
                                                        <div class="ms-3">
                                                            <div class="text-user">'.$kk['TenTK'].'</div>
                                                    ...
                                                    <p class="mb-0"><strong>Tên Sản Phẩm:</strong> Yến Sào
                                                        Cao Cấp Loại 2</p>
                                                    <p class="mb-3"><strong>Mô Tả:</strong> '.$kk['NoiDung'].'
                                                    </p>
                                                    <div class="d-flex">
                                                        <img src="public/img/'.$kk['HinhAnh'].'"
